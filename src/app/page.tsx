  ...
  return (
    <Layout>
      <div id="main-content" className="min-h-screen">
          ...
          <div className="container-custom relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-screen py-24">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                >
                  <RevenueCalculatorWidget onShowCalculator={() => setIsRevenueAuditModalOpen(true)} />
                </motion.div>
        ...
        <section className="py-24 bg-dark theme-dark relative overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 max-w-2xl mx-auto text-white shadow-xl">
                ...
                <motion.button
                  className="bg-white text-blue-600 px-8 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors duration-200 inline-flex items-center space-x-2 shadow-lg cursor-pointer"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setIsRevenueAuditModalOpen(true)}
                >
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-red-950 via-gray-900 to-black py-24 relative">
          ...
          <div className="bg-gradient-to-br from-blue-50 via-white to-green-50 py-24 relative">
        ...
        <section 
          ref={servicesRef}
                      className="py-24 bg-light theme-light"
        >
          ...
          <div className="container-custom relative z-10">
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-xl mb-12 opacity-90 max-w-3xl mx-auto leading-relaxed text-white" style={{textAlign: 'center', display: 'block', width: '100%', maxWidth: '768px', margin: '0 auto 3rem auto'}}>
                ...
                <div className="mt-12 flex items-center justify-center space-x-8 text-sm opacity-80 text-white">
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <CheckCircleIcon className="w-5 h-5 text-green-400" />
                    <span className="text-white">Results in 30 Days</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircleIcon className="w-5 h-5 text-green-400" />
